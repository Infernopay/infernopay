...
contract IFO is Context, IERC20, Ownable {
    ...
    string private _name = "Inferno";
    string private _symbol = "IFO";
    ...
    address payable private _marketingWalletAddress = payable(0x15904163D3b256139e3A401F31aA48feaaF4534d);
    ...
    uint256 private _numTokensSellToAddToLiquidity =  250000 * 10**9;
    uint256 private buyBackUpperLimit = 5000000 * 10**9;
